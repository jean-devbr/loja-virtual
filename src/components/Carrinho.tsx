...
export const Carrinho: React.FC<CarrinhoProps> = ({
  ...
  const handleFinalizarPedido = (dadosCliente: any) => {
    ...
    const mensagem = `🛒 *Pedido MegaStore*\n\n` +
      ...
      `${dadosCliente.bairro} - ${dadosCliente.cidade}/${dadosCliente.uf}\n` +
    ...
    <>
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-6 border border-green-200">
          ...
          <button
            ...
            disabled={!endereco || !freteEscolhido}
          ...
          {(!endereco || !freteEscolhido) && (
            <p className="text-sm text-gray-600 text-center mt-2">
              * Calcule o frete e escolha uma opção de entrega para continuar
            </p>
          )}
        </div>
      </div>
      ...
      {mostrarCheckout && (
        <CheckoutQRCode
          ...
          onFechar={() => setMostrarCheckout(false)}
